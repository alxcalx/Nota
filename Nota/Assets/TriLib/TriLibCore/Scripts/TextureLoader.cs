...
{
    /// <summary>
    /// Represents a class used to load textures.
    /// </summary>
    public static class TextureLoader
    {
        /// <summary>
        /// Loads a new texture using the given context data.
        /// </summary>
        ...
        private static void ScanForAlphaPixels(TextureLoadingContext textureLoadingContext)
        {
            ...
            {
                for (var i = 4; i < textureLoadingContext.Data16.Length; i += 4)
                {
            ...
            {
                for (var i = 4; i < textureLoadingContext.Data.Length; i += 4)
                {
            ...
            textureLoadingContext.Texture.HasAlpha = hasAlpha;
        }
