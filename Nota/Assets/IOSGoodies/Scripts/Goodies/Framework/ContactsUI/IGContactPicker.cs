#if UNITY_IOS && !DISABLE_CONTACT_PICKER
namespace DeadMosquito.IosGoodies
{
	...
	public static class IGContactPicker
	{
		...
		public static void PickContact(Action<Contact> onSuccess, Action onCancel)
		{
			...
			Action<string> cb = str => onCancel();
			_showContactPicker(ContactPickerCallback, IGUtils.ActionStringCallback, onSuccess.GetPointer(), cb.GetPointer());
		}
